...
public class ParticipantsController implements  ICompetitionObserver {
    private Stage stage;
    ...
    public void setServer( User crtUser,Stage parent,Stage currentStage,ICompetitionServices server) {//Stage stage,
    ...
    public void handleAddParticipant(){
        ...
        int id=modelParticipant.get(modelParticipant.size()-1).getId();
